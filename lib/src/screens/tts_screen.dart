...
class _TTSScreenState extends State<TTSScreen> {
  ...
  void listenSpeech() async {
    print("Inside listen speech function");
    if (available) {
      print("available bhi h bhai");
      speech.listen(onResult: (res) {
        print("We got a response from Speech Listerner: ");
        print(res);
  ...
  void initSTT() async {
    available =
        await speech.initialize(onStatus: (status) {}, onError: (err) {});
  }
